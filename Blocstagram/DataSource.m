...
//        //TEST - (1) Is infinite scroll event ever triggered more than once? (2) Does this method block the main thread?
//        [NSThread sleepForTimeInterval:5.0f]; // From my test, (1) No, (2) Yes.
