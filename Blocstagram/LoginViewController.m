...
//  Blocstagram
//
//  Created by psytronx on 7/28/15.
...
NSString *const LoginViewControllerDidGetAccessTokenNotification = @"LoginViewControllerDidGetAccessTokenNotification"; // The string literal is just placeholder data. Can be anything.
...
- (void)viewDidLoad {
    ...
    // Nagivate to instagram login page
