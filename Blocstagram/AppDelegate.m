...
//  Blocstagram
//
//  Created by psytronx on 7/21/15.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // First load Instagram login view
...
//    self.window.rootViewController = [[UINavigationController alloc] initWithRootViewController:[[LoginViewController alloc] init]]; // Why not do this instead?
